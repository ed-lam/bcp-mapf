...
//     Int out1_begin_;           // Index of the first out edge for agent 1
//     Int in2_begin_;            // Index of the first in edge for agent 2
//     Int out2_begin_;           // Index of the first out edge for agent 2
//
