...
#define SEPA_NAME                        "tripleedge_conflicts"
#define SEPA_DESC         "Separator for triple-edge conflicts"
...
SCIP_RETCODE tripleedge_conflicts_create_cut(
    SCIP* scip,                 // SCIP
...
)
{
    ...
    auto name = fmt::format("tripleedge_conflict("
                            "{},{},"
                            "(({},{}),({},{}),{}),"
                            "(({},{}),({},{}),{}),"
                            "(({},{}),({},{}),{}),"
    ...
    TwoAgentRobustCut cut(scip, a1, a2, a1_et1.t, 3, 3
#ifdef DEBUG
        , std::move(name)
#endif
    );
    cut.edges_a1(0) = a1_et1.et.e;
    cut.edges_a1(1) = a1_et2.et.e;
    cut.edges_a1(2) = a1_et3.et.e;
    cut.edges_a2(0) = a2_et1.et.e;
    cut.edges_a2(1) = a2_et2.et.e;
    cut.edges_a2(2) = a2_et3.et.e;
...
// Separator
static
SCIP_RETCODE tripleedge_conflicts_separate(
    SCIP* scip,            // SCIP
    SCIP_SEPA* sepa,       // Separator
...
{
    // Print.
    debugln("Starting separator for triple-edge conflicts on solution with obj {:.6f}:",
        ...
        for (const auto [a1_et1, a1_et1_val] : agent_edges_a1)
        {
            ...
            for (Agent a2 = 0; a2 < N; ++a2)
                if (a2 != a1)
                {
                    ...
                    // Loop through the second edge of both agents.
                    ...
                    {
                        // Get the values of the second edge of both agents.
                        const auto a2_et2 = a1_et2;
                        const auto a1_et2_it = agent_edges_with_waits_a1.find(a1_et2);
                        const auto a2_et2_it = agent_edges_with_waits_a2.find(a2_et2);
                        if (a1_et2_it == agent_edges_with_waits_a1.end() && a2_et2_it == agent_edges_with_waits_a2.end())
                        {
                            continue;
                        }
                        const auto a1_et2_val = a1_et2_it != agent_edges_with_waits_a1.end() ? a1_et2_it->second : 0;
                        const auto a2_et2_val = a2_et2_it != agent_edges_with_waits_a2.end() ? a2_et2_it->second : 0;

                        // Find a cut with an edge conflict.
                        for (const auto [a1_et3, a1_et3_val] : agent_edges_a1)
                            if (a1_et3 != a1_et1 &&
                                a1_et3.t == a1_et2.t &&
                                ((map.get_destination(a1_et3.et.e) == a1_et1.n && map.get_destination(a1_et3.et.e) == a1_et2.n) ||
                                 (a1_et3.n == map.get_destination(a1_et1.et.e) && a1_et3.n == a1_et2.n)))
                            {
                                const EdgeTime a2_et3{map.get_opposite_edge(a1_et3.et.e), a1_et3.t};
                                const auto a2_et3_it = agent_edges_a2.find(a2_et3);
                                const auto a2_et3_val = a2_et3_it != agent_edges_a2.end() ? a2_et3_it->second : 0;
...
//                                    println("{} {} {} {} {} {}", a1_et1_val, a1_et2_val, a1_et3_val, a2_et1_val, a2_et2_val, a2_et3_val);
...
#ifdef PRINT_DEBUG
                                    {
                                        ...
                                        debugln("   Creating triple-edge conflict cut on edges "
                                                "(({},{}),({},{}),{}), (({},{}),({},{}),{}) and (({},{}),({},{}),{}) for agent {} and "
                                                "(({},{}),({},{}),{}), (({},{}),({},{}),{}) and (({},{}),({},{}),{}) for agent {} "
                                    ...
                                    // Create cut.
                                    SCIP_CALL(tripleedge_conflicts_create_cut(scip,
                                                                              probdata,
                                                                              sepa,
                                                                              a1,
                                                                              a2,
...
static
SCIP_DECL_SEPACOPY(sepaCopyTripleEdgeConflicts)
{
    // Check.
    debug_assert(scip);
    debug_assert(sepa);
...
#pragma GCC diagnostic ignored "-Wunused-parameter"
static
SCIP_DECL_SEPAEXECLP(sepaExeclpTripleEdgeConflicts)
{
    // Check.
    debug_assert(scip);
    debug_assert(sepa);
    ...
    *result = SCIP_DIDNOTFIND;
    ...
    // Start separator.
    SCIP_CALL(tripleedge_conflicts_separate(scip, sepa, result));
...
// Create separator for triple-edge conflicts constraints and include it in SCIP
SCIP_RETCODE SCIPincludeSepaTripleEdgeConflicts(
    SCIP* scip    // SCIP
)
{
    // Check.
    ...
    SCIP_CALL(SCIPincludeSepaBasic(scip,
                                   ...
                                   SEPA_USESSUBSCIP,
                                   SEPA_DELAY,
                                   sepaExeclpTripleEdgeConflicts,
                                   nullptr,
                                   nullptr));
    debug_assert(sepa);

    // Set callbacks.
    SCIP_CALL(SCIPsetSepaCopy(scip, sepa, sepaCopyTripleEdgeConflicts));
